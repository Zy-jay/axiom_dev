...
export const getTokenHoldersSum = async (tokenAddress, chainId) => {
  try {
    // console.debug("chainId: ", chainId, "0x" + chainId?.toString(16));
    const response = await Moralis.EvmApi.token.getTokenOwners({
      chain: chainId ? "0x" + chainId?.toString(16) : "0xa4b1",
      order: "ASC",
